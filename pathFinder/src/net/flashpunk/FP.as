package net.flashpunk 
{
	...
	public class FP 
	{
		...
		//public static var POINT0:Point = new Point(0, 0);
		...
		public static function getBitmap(source:Class):BitmapData
		{
			...
			if(Class(source).hasOwnProperty("bitmapData")){
				_bitmap[source] = source.bitmapData;
			}else{
				_bitmap[source] = (new source).bitmapData;
			}
			return _bitmap[source];
		}
